				...
				<Box sx={{ display: "flex", gap: 5, alignItems: "self-start" }}>
					...
					<Box>
						...
						<Typography sx={{ color: "#5E646A" }}>
							We have found some items that might belong to you. If that is the case, please claim
							it by submitting a claim request. In order to submit a claim request, please click the
